...
@try_export
def export_engine(onnx_model_path,engine_path, workspace=4,half=2):
    # 创建TensorRT的Logger对象
    ...
    # 判断是否使用float16精度
    if builder.platform_has_fast_fp16 and half==1:
        config.set_flag(trt.BuilderFlag.FP16)
    elif builder.platform_has_fast_int8 and half==2:
